...
export function organizeMenuByCategory(menuItems: MenuItem[], categories: MenuCategory[]): OrganizedMenu {
    ...
    menuItems.forEach((item) => {
        ...
        if (category) {
            const organizedCategory = organizedMenu.find((cat) => cat._id === category._id);
