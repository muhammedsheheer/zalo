...
export const getFilteredMenuItems = ({ data, query }: { data: OrganizedMenu; query: string }) => {
    ...
    filteredMenuItems = filteredMenuItems.filter((category) => category.items.length > 0);
